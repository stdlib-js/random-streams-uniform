...
/**
* Class for creating readable streams which generate a stream of pseudorandom numbers drawn from a uniform distribution.
*/
...
interface Constructor {
	...
	*/
	...
	/**
	* Returns an "objectMode" readable stream for generating a stream of pseudorandom numbers drawn from a uniform distribution.
	*
	* @param a - minimum support
	* @param b - maximum support
	* @param options - stream options
