...
```bash
npm install @stdlib/random-streams-uniform
```
...
```bash
npm install -g @stdlib/random-streams-uniform
```
...
[dependencies-image]: https://img.shields.io/david/stdlib-js/random-streams-uniform
